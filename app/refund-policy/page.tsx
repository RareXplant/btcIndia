    ...
    return (
        <main>
            ...
            <div className="px-4 text-gray-800 space-y-4 py-8">
                ...
                <ul>
                    <li>
                        <p>
                            ...
                            refers to BTC India, Nandial Kachhi, Bard No. 1, Khargapur, Tikamgarh, Madhya Pradesh 472115.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to BTC India,
                            accessible from{" "}
                            <a
                                href="https://btcindia.site/"
                                target="_blank"
                ...
                <ul>
                    <li>By email: info@btcindia.site</li>
                </ul>
                <p>
                ...
                <p>
                    Nandial Kachhi, Bard No. 1, Khargapur, Tikamgarh,
                    <br />
